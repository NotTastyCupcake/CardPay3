        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdLocality = table.Column<int>(type: "int", nullable: true),
                    StreetType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IdStreet = table.Column<int>(type: "int", nullable: true),
                    NumHome = table.Column<int>(type: "int", nullable: true),
                    NumCase = table.Column<int>(type: "int", nullable: true),
                    NumApartment = table.Column<int>(type: "int", nullable: true),
                    IdType = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
